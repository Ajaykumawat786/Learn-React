    ...
    return (
        <div className="py-5">
            <div className="flex  justify-between p-5 ">
                ...
                <div className="w-1/2">
                    <p className=" bg-sky-800 rounded w-2/3 text-2xl text-white p-2  ">Know About Ganesham Realty</p>
                    <h2 className="text-4xl py-5 font-bold"> About <span className="">Ganesham Realty</span></h2>
                    <p className="text-2xl">At Ganesham Realty, we know real estate is much more than properties; it includes people, purpose, and possibilities. We are a registered company with years of experience, passion, and commitment to the industry. We make purchasing a first house, selling a commercial space, or starting a new property smooth and satisfying.
